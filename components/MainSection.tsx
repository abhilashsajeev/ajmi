    ...
    <>
      <section className="w-full">
        <div className="relative w-full ">
          ...
          <div className="flex flex-col text-start justify-start items-center w-3/5 absolute top-1/2">
            <div className="font-bold col-span-5 w-3/4 uppercase max-md:mt-10 max-md:max-w-full text-6xl ml-10 text-black">
              Better living begins at home.
            </div>
          </div>
          <div className="flex flex-col absolute top-3/4">
            <div className="flex gap-4 m-14 text-sm w-3/5 max-md:flex-wrap max-md:mt-10">
              <div className="font-bold  uppercase">HOUSE OF WOOD PROJECT</div>
              <div className="flex-auto font-medium leading-1  text-sm text-gray-500">
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-5/12 max-md:ml-0 max-md:w-full">
            <div className="flex text-7xl flex-col self-stretch px-5 my-auto tracking-normal text-black  max-md:max-w-full max-md:text-4xl">
              <div className="font-bold top-10 uppercase max-md:mt-10 max-md:max-w-full">
                Better living begins at home.
              </div>
